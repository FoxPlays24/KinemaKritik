...
export const getFilms = (req, res) => {
    db.query(`SELECT films.id, title, original_title, description, film_types.name film_type, age_limits.name age_limit, release_date, release_date_streams, release_date_russia, page_primary_color
...
export const getReviews = (req, res) => {
    let id = req.params.film_id
    db.query(`SELECT reviews.id, users.login, profiles.username, picture, title, content, liked, reviews.created_at FROM reviews 
