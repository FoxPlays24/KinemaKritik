...
export function Input() {
  return ( 
    ...
    <button className="hidden lg:flex items-center">
      ...
      <input placeholder="Поиск..." spellCheck="false" className="bg-slate-200 text-lg focus:outline-none focus:ring-2 ring-slate-400 p-2 rounded-2xl w-full even:ps-10" />
    </button>
    </>
  )
}