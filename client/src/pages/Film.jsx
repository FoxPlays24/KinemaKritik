...
const Film = () => {
  ...
  <div className='flex flex-col px-4 gap-4'> 
    {
      banner 
      ? <img src={banner} alt='Banner' className='rounded-2xl' loading='eager' /> 
      : <div className='bg-repeat h-52 rounded-2xl' style={{backgroundImage: `url(${require('../img/misc/placeholder.png')})`}} />
    }
    <div>

      <div className='flex items-center'>
        <span className='text-2xl font-semibold truncate'>{film.title}</span>
        <span className='text-sm text-end ml-auto'>{film.age_limit} {film.original_title} {new Date(film.release_date).getFullYear()}</span>
      </div>

      <div className='flex flex-col lg:flex-row items-center'>
        <div className='flex flex-row justify-center lg:justify-start gap-2 select-none my-2'>
          <a href='.' className={`text-sm text-white bg-black rounded-2xl px-4 py-2 cursor-default`}>
            Инфо
          </a>
          <a href='.' className='text-sm bg-white rounded-2xl px-4 py-2 border-black border transition hover:bg-zinc-200'>
            Рецензии
          </a>
          <a href='.' className='text-sm bg-white rounded-2xl px-4 py-2 border-black border transition hover:bg-zinc-200'>
            Состав
        ...
        <div className='flex flex-row gap-2 justify-center lg:ml-auto lg:translate-x-2'>
          <img src={require('../img/awards/SAG.png')} alt='SAG' className='size-12 p-1 object-contain' />
          <img src={require('../img/awards/Saturn.png')} alt='Saturn' className='size-12 p-1 object-contain' />
          <img src={require('../img/awards/BAFTA.png')} alt='BAFTA' className='size-12 p-1 object-contain' />
          <img src={require('../img/awards/Golden Globe.png')} alt='Golden Globe' className='size-12 p-1 object-contain' />
          <img src={require('../img/awards/Oscar.png')} alt='Oscar' className='size-12 p-1 object-contain' />
        </div>
      </div>
    </div>
    <div className='flex flex-col lg:flex-row items-center mt-8 select-none gap-8'>
